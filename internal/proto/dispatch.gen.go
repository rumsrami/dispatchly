...
func WebRPCSchemaHash() string {
	return "101fdf060091ac93b74d8620c25af822bc245a76"
}
...
type GetScheduleResponse struct {
	Schedule map[int][]*Slot `json:"schedule"`
}

type Slot struct {
	StartHour string   `json:"startHour"`
	TaskSlot  []string `json:"taskSlot"`
}
...
type UpdateTaskRequest struct {
	...
	Day          int      `json:"day"`
	StartHour    []string `json:"startHour"`
	NewStartHour string   `json:"newStartHour"`
	NewEndHour   string   `json:"newEndHour"`
	NewDuration  int      `json:"newDuration"`
	NewOperation string   `json:"newOperation"`
}

type Dispatch interface {
	Ping(ctx context.Context) (bool, error)
	Version(ctx context.Context) (*Version, error)
	ReadSchedule(ctx context.Context, req *GetScheduleRequest) (*GetScheduleResponse, error)
	CreateTask(ctx context.Context, req *CreateTaskRequest) (bool, error)
	DeleteTask(ctx context.Context, req *DeleteTaskRequest) (bool, error)
	UpdateTask(ctx context.Context, req *UpdateTaskRequest) (bool, error)
}
...
func NewDispatchServer(svc Dispatch) WebRPCServer {
...
func (s *dispatchServer) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	ctx = context.WithValue(ctx, ServiceNameCtxKey, "Dispatch")
	...
	switch r.URL.Path {
	case "/rpc/Dispatch/Ping":
		s.servePing(ctx, w, r)
		return
	case "/rpc/Dispatch/Version":
		s.serveVersion(ctx, w, r)
		return
	case "/rpc/Dispatch/ReadSchedule":
		s.serveReadSchedule(ctx, w, r)
		return
	case "/rpc/Dispatch/CreateTask":
		s.serveCreateTask(ctx, w, r)
		return
	case "/rpc/Dispatch/DeleteTask":
		s.serveDeleteTask(ctx, w, r)
		return
	case "/rpc/Dispatch/UpdateTask":
		s.serveUpdateTask(ctx, w, r)
		return
	default:
...
func (s *dispatchServer) servePing(ctx context.Context, w http.ResponseWriter, r *http.Request) {
...
func (s *dispatchServer) servePingJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
...
func (s *dispatchServer) serveVersion(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *dispatchServer) serveVersionJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
	...
	func() {
		...
		ret0, err = s.Dispatch.Version(ctx)
	}()
	respContent := struct {
...
func (s *dispatchServer) serveReadSchedule(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveReadScheduleJSON(ctx, w, r)
	default:
		err := Errorf(ErrBadRoute, "unexpected Content-Type: %q", r.Header.Get("Content-Type"))
		RespondWithError(w, err)
	}
...
func (s *dispatchServer) serveReadScheduleJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
	ctx = context.WithValue(ctx, MethodNameCtxKey, "ReadSchedule")
	reqContent := struct {
		Arg0 *GetScheduleRequest `json:"req"`
	}{}
	...
	func() {
		...
		ret0, err = s.Dispatch.ReadSchedule(ctx, reqContent.Arg0)
	}()
	respContent := struct {
		Ret0 *GetScheduleResponse `json:"res"`
	}{ret0}
...
func (s *dispatchServer) serveCreateTask(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *dispatchServer) serveCreateTaskJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
	ctx = context.WithValue(ctx, MethodNameCtxKey, "CreateTask")
	reqContent := struct {
		Arg0 *CreateTaskRequest `json:"req"`
	}{}
	...
	func() {
		...
		ret0, err = s.Dispatch.CreateTask(ctx, reqContent.Arg0)
	}()
	respContent := struct {
		Ret0 bool `json:"res"`
	}{ret0}
...
func (s *dispatchServer) serveDeleteTask(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *dispatchServer) serveDeleteTaskJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
	ctx = context.WithValue(ctx, MethodNameCtxKey, "DeleteTask")
	reqContent := struct {
		Arg0 *DeleteTaskRequest `json:"req"`
	}{}
	...
	func() {
		...
		ret0, err = s.Dispatch.DeleteTask(ctx, reqContent.Arg0)
	}()
	respContent := struct {
		Ret0 bool `json:"res"`
	}{ret0}
...
func (s *dispatchServer) serveUpdateTask(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *dispatchServer) serveUpdateTaskJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
	ctx = context.WithValue(ctx, MethodNameCtxKey, "UpdateTask")
	reqContent := struct {
		Arg0 *UpdateTaskRequest `json:"req"`
	}{}
	...
	func() {
		...
		ret0, err = s.Dispatch.UpdateTask(ctx, reqContent.Arg0)
	}()
	respContent := struct {
		Ret0 bool `json:"res"`
	}{ret0}
...
const DispatchPathPrefix = "/rpc/Dispatch/"
...
func NewDispatchClient(addr string, client HTTPClient) Dispatch {
	prefix := urlBase(addr) + DispatchPathPrefix
	urls := [6]string{
		prefix + "Ping",
		prefix + "Version",
		prefix + "ReadSchedule",
...
func (c *dispatchClient) Ping(ctx context.Context) (bool, error) {
	out := struct {
		Ret0 bool `json:"status"`
	}{}
...
func (c *dispatchClient) Version(ctx context.Context) (*Version, error) {
	out := struct {
		Ret0 *Version `json:"version"`
	}{}
...
func (c *dispatchClient) ReadSchedule(ctx context.Context, req *GetScheduleRequest) (*GetScheduleResponse, error) {
	in := struct {
		Arg0 *GetScheduleRequest `json:"req"`
	}{req}
	out := struct {
...
func (c *dispatchClient) CreateTask(ctx context.Context, req *CreateTaskRequest) (bool, error) {
	in := struct {
		Arg0 *CreateTaskRequest `json:"req"`
	}{req}
	out := struct {
...
func (c *dispatchClient) DeleteTask(ctx context.Context, req *DeleteTaskRequest) (bool, error) {
	in := struct {
		Arg0 *DeleteTaskRequest `json:"req"`
	}{req}
	out := struct {
...
func (c *dispatchClient) UpdateTask(ctx context.Context, req *UpdateTaskRequest) (bool, error) {
	in := struct {
		Arg0 *UpdateTaskRequest `json:"req"`
	}{req}
	out := struct {
